...
var text = svg.selectAll("text")
    ...
    .data(dataset)
    //goes into enter mode
    .enter()
    //appends text to every item and keep its value to be the number itself
    .append("text")
    //gets the value of the data item
    .text(function(d) {
        return d;
    })
    //gives y attribute but, it has to be slightley higher because we want the text to be over the bars
    .attr("y", function(d, i) {
